            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Text(
                    "Captain America is one of Marvel Comics' most iconic superheroes, first appearing in Captain America Comics #1 in 1941. Created by Joe Simon and Jack Kirby, Captain America, whose real name is Steve Rogers, symbolizes the ideal of heroism and patriotism, especially during World War II.",
                    style: GoogleFonts.marvel(
                        textStyle:
                    ...
                    children: [
                      Container(
                        ...
                        child: const YoutubeVideoPlayer(
                            videoUrl:
                                'https://youtu.be/7SlILk2WMTI?si=ZzTUmoVklfaFwPK8'),
                      ),
                      Container(
                        height: 170,
                        width: 200,
                        ...
                        child: const YoutubeVideoPlayer(
                            videoUrl:
                                'https://youtu.be/3ToFd5vubXY?si=vubF_NVimzWqIyhK'),
                      )
                    ],
                  )
                ],
